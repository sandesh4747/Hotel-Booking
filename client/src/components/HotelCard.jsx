...
export default function HotelCard({ room, index }) {
  return (
    //This makes the entire card clickable and navigates to a dynamic route like /rooms/123 (where 123 is the room's unique ID).
    <Link
      to={"/rooms/" + room._id}
      onClick={() => scrollTo(0, 0)}
      //When the card is clicked, this scrolls the page back to the top  (x=0, y=0)
      key={room._id}
